...
export default function Suggested() {
    ...
    return(
        ...
        <div className="for-you__recommended--books">
            {/* dont forget to change divs to links */}
            {/* create book component later */}
            <div className="for-you__recommended--books-link">
            <div></div>
            <figure className="book__image--wrapper">
            <img className="book__image" src="https://firebasestorage.googleapis.com/v0/b/summaristt.appspot.com/o/books%2Fimages%2Fhow-to-win-friends-and-influence-people.png?alt=media&amp;token=099193aa-4d85-4e22-8eb7-55f12a235fe2" alt="book" />
            </figure>
